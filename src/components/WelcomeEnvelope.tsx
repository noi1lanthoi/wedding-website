    ...
    >
      <div className="relative w-full max-w-lg px-4 perspective-1000">
        ...
        >
          ...
          <div
            className="absolute bottom-0 left-0 w-full h-full bg-[#FAFAFA] z-10 pointer-events-none"
            style={{
              clipPath: "polygon(0 0, 50% 50%, 100% 0, 100% 100%, 0 100%)",
              background: "linear-gradient(to bottom, #f7f3e8, #FDFBF7)",
            }}
          />
          ...
          >
            <div className="w-16 h-16 md:w-20 md:h-20 rounded-full bg-gold shadow-lg flex items-center justify-center border-4 border-dusty-rose relative group-hover:scale-105 transition-transform duration-300">
              ...
              <span className="font-script text-white text-2xl font-bold">
                H&T
              </span>
            </div>
            <motion.p
          ...
          <motion.div
            className="absolute inset-x-8 top-12 bottom-4 bg-white shadow-inner p-6 flex flex-col items-center justify-center text-center border border-gold/20"
            initial={{ y: 0 }}
          ...
          >
            ...
            <h2 className="font-script text-3xl text-dark mb-1">
              Trần Minh Hưng
            </h2>
            <span className="text-gold text-lg">&</span>
            <h2 className="font-script text-3xl text-dark mb-4">
